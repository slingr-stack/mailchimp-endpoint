...
need to configure webhooks on each list.

According to the documentation of the [format of webhooks](https://mailchimp.com/developer/marketing/guides/sync-audience-data-webhooks/#handling-the-webhook-response-in-your-application)
